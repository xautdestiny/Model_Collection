...
def default_regression_model(num_anchors, pyramid_feature_size=32,
...
def mobilenet_retinanet(num_classes=21, input_shape = (800, 1000, 3) ,backbone='mobilenet224_1.0', inputs=None, modifier=None, **kwargs):
    ...
    return retinanet(inputs=inputs, num_classes=num_classes, backbone_layers=mobilenet.outputs, **kwargs)
