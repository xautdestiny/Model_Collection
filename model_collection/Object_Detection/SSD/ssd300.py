...
def ssd_300(image_size,
    ...
    conv4_3_norm = Lambda(l2normalization)(conv4_3)
...
def create_ssd300(input_shape=(300, 300, 3)):
    img_height = input_shape[0] # Height of the model input images
    img_width = input_shape[1] # Width of the model input images
