...
def create_rpn(input_shape=(480, 640, 3),num_anchors=15):
    ...
    # return keras.models.Model(inputs, [regr6, pred6, regr5, pred5, regr4, pred4, regr3, pred3, regr2, pred2, P6, P5, P4, P3, P2])
    # return keras.models.Model(inputs, [base_feature, x_pred, x_regr])
...
def create_detectron_fpn_mfrcnn_resnet50v1(shape):
    model1 = create_rpn(shape)
    model2 = mask_frcnn_pred(nb_classes=81, pooling_regions=7, hidden_dim= 1024, dim_in=256)
...
if __name__ == "__main__":
    ...
    rpn_model.save("R-50_FPN_800x640.hdf5")
    
    K.clear_session()
    rpn_model = rpn_create((640, 480, 3))
    rpn_model.save("R-50_FPN_640x480.hdf5")

    K.clear_session()
    rpn_model = rpn_create((480, 320, 3))
    rpn_model.save("R-50_FPN_480x320.hdf5")
