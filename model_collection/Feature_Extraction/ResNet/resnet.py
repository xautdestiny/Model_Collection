...
if __name__ == "__main__":
  ...
  #model.save("resnet50_224_224.hdf5")

  #model = ResNet101((224, 224, 3), 1000)
  #model.save("resnet101_224w_224h.hdf5")

  model = ResNet152((224, 224, 3), 1000)
  model.save("resnet152_224_224.hdf5")
