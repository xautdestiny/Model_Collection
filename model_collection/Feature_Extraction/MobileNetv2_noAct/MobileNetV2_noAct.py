...
def InvertedResidualBlock(x, expand, out_channels, repeats, stride, weight_decay, block_id):
    ...
    x = Lambda(relu6, name='conv_%d_0_act_1' % block_id)(x)
    ...
    x = Lambda(relu6, name='conv_%d_0_act_2' % block_id)(x)
    ...
    for i in range(1, repeats):
        ...
        x1 = Lambda(relu6, name='conv_%d_%d_act_1' % (block_id, i))(x1)
        ...
        x1 = Lambda(relu6, name='conv_dw_%d_%d_act_2' % (block_id, i))(x1)
        ...
        x = Add(name='block_%d_%d_output' % (block_id, i))([x, x1])
    return x
...
def conv_block(inputs, filters, weight_decay, name, kernel=(3, 3), strides=(1, 1)):
    ...
    return Lambda(relu6, name=name+'_relu')(x)


def MobileNetV2(input_shape, classes=1000, weight_decay=0.01, feat_dropout=0., input_tensor=None):
    '''
    ...
    x = Lambda(relu6, name='act_softmax')(x)
